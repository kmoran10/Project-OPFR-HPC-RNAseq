...
vp_Elevel_low <- ggplot(data = dc, 
  ...
  labs(title = "A. Differential Gene Expression in HPC - E Level: Low",
       x="log2 Fold Change",
...
write.csv(top25sigdiff_genes_Elevel_low,"results/results_tables/top25sigdiff_genes_Elevel_low.csv", row.names = F)

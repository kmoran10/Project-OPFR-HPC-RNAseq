...
d0 = DGEList(d, group = coldata$treatment)
dim(d0)
...
contr.matrix <- makeContrasts(group.dlOil-group.dlOPFR,
                              levels = design.dl)
...
saveRDS(v.dl, "results/limma_vdl_TREATMENT.RDS")
...
saveRDS(q.dl,("results/limma_vdl_cutoff5_2000_tworand_TREATMENT.RDS"))
